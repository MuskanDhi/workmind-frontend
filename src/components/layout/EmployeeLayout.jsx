...
import { Brain, Home, History, User, LogOut } from 'lucide-react';
    ...
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
      <aside className="fixed inset-y-0 left-0 w-64 bg-navy text-white flex flex-col z-10">
        <div className="p-6 flex items-center space-x-3">
          ...
          <span className="ml-2 bg-teal/30 text-tealLight text-xs px-2 py-0.5 rounded-full uppercase tracking-wider font-semibold">
            Employee
          </span>
        </div>
        ...
        <div className="p-4 border-t border-white/10">
          <div className="flex items-center space-x-3 px-4 py-3">
            <div className="w-8 h-8 rounded-full bg-teal flex items-center justify-center font-bold text-sm">
